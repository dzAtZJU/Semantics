...
@objc public extension Iconic {
     ...
     */
    class func fontAwesomeIconFont(ofSize size: CGFloat) -> UIFont {
     ...
     */
    class func attributedString(withIcon icon: FontAwesomeIcon, pointSize: CGFloat, color: UIColor?) -> NSAttributedString {
     ...
     */
    class func attributedString(withIcon icon: FontAwesomeIcon, pointSize: CGFloat, color: UIColor?, edgeInsets: UIEdgeInsets) -> NSAttributedString {
     ...
     */
    class func image(withIcon icon: FontAwesomeIcon, size: CGSize, color: UIColor?) -> UIImage {
     ...
     */
    class func image(withIcon icon: FontAwesomeIcon, size: CGSize, color: UIColor?, edgeInsets: UIEdgeInsets) -> UIImage {
     ...
     */
    class func registerFontAwesomeIcon() {
     ...
     */
    class func unregisterFontAwesomeIcon() {
...
@IBDesignable
public final class FontAwesomeIconView: IconImageView {
    ...
    dynamic public var iconName: String = "" {
        willSet {
            iconDrawable = FontAwesomeIcon(named: newValue)
        }
    }
...
@objc public extension UIButton {
     ...
     */
    func setIconImage(withIcon icon: FontAwesomeIcon, size: CGSize, color: UIColor?, forState state: UIControl.State) {
...
@objc public enum FontAwesomeIcon: Int, CaseIterable {
    case _279Icon
    case _283Icon
    case _303Icon
    case _312Icon
...
extension FontAwesomeIcon : IconDrawable {
    ...
    public init(named iconName: String, fallbackIconName: String) {
        ...
        case "zoom_in": self = .zoomInIcon
        case "zoom_out": self = .zoomOutIcon
        default: self = FontAwesomeIcon(named: fallbackIconName)
        }
    }
    ...
    public init(unicode: String) {
        switch unicode {
        case  "\u{F129}": self = ._279Icon
        case  "\u{F12D}": self = ._283Icon
        case  "\u{F143}": self = ._303Icon
        case  "\u{F14C}": self = ._312Icon
        case  "\u{F152}": self = ._317Icon
        case  "\u{F15E}": self = ._329Icon
        case  "\u{F164}": self = ._334Icon
        case  "\u{F165}": self = ._335Icon
        case  "\u{F186}": self = ._366Icon
        case  "\u{F18C}": self = ._372Icon
        case  "\u{F18E}": self = ._374Icon
        case  "\u{F191}": self = ._376Icon
        case  "\u{F193}": self = ._378Icon
        case  "\u{F195}": self = ._380Icon
        case  "\u{F197}": self = ._382Icon
        case  "\u{F198}": self = ._383Icon
        case  "\u{F199}": self = ._384Icon
        case  "\u{F19A}": self = ._385Icon
        case  "\u{F19B}": self = ._386Icon
        case  "\u{F19C}": self = ._387Icon
        case  "\u{F19D}": self = ._388Icon
        case  "\u{F19E}": self = ._389Icon
        case  "\u{F1A2}": self = ._392Icon
        case  "\u{F1A3}": self = ._393Icon
        case  "\u{F1A5}": self = ._395Icon
        case  "\u{F1A6}": self = ._396Icon
        case  "\u{F1A7}": self = ._397Icon
        case  "\u{F1A8}": self = ._398Icon
        case  "\u{F1A9}": self = ._399Icon
        case  "\u{F1AA}": self = ._400Icon
        case  "\u{F1AC}": self = ._402Icon
        case  "\u{F1AD}": self = ._403Icon
        case  "\u{F1AE}": self = ._404Icon
        case  "\u{F1B1}": self = ._406Icon
        case  "\u{F1B2}": self = ._407Icon
        case  "\u{F1B3}": self = ._408Icon
        case  "\u{F1B4}": self = ._409Icon
        case  "\u{F1B5}": self = ._410Icon
        case  "\u{F1B6}": self = ._411Icon
        case  "\u{F1B7}": self = ._412Icon
        case  "\u{F1B8}": self = ._413Icon
        case  "\u{F1B9}": self = ._414Icon
        case  "\u{F1BA}": self = ._415Icon
        case  "\u{F1BB}": self = ._416Icon
        case  "\u{F1BC}": self = ._417Icon
        case  "\u{F1BD}": self = ._418Icon
        case  "\u{F1BE}": self = ._419Icon
        case  "\u{F1C2}": self = ._422Icon
        case  "\u{F1C3}": self = ._423Icon
        case  "\u{F1C4}": self = ._424Icon
        case  "\u{F1C5}": self = ._425Icon
        case  "\u{F1C6}": self = ._426Icon
        case  "\u{F1C7}": self = ._427Icon
        case  "\u{F1C8}": self = ._428Icon
        case  "\u{F1C9}": self = ._429Icon
        case  "\u{F1CA}": self = ._430Icon
        case  "\u{F1CB}": self = ._431Icon
        case  "\u{F1CC}": self = ._432Icon
        case  "\u{F1CD}": self = ._433Icon
        case  "\u{F1CE}": self = ._434Icon
        case  "\u{F1D3}": self = ._438Icon
        case  "\u{F1D4}": self = ._439Icon
        case  "\u{F1D8}": self = ._443Icon
        case  "\u{F1D9}": self = ._444Icon
        case  "\u{F1DA}": self = ._445Icon
        case  "\u{F1DB}": self = ._446Icon
        case  "\u{F1DC}": self = ._447Icon
        case  "\u{F1DD}": self = ._448Icon
        case  "\u{F1DE}": self = ._449Icon
        case  "\u{F1E1}": self = ._451Icon
        case  "\u{F1E2}": self = ._452Icon
        case  "\u{F1E3}": self = ._453Icon
        case  "\u{F1E4}": self = ._454Icon
        case  "\u{F1E5}": self = ._455Icon
        case  "\u{F1E6}": self = ._456Icon
        case  "\u{F1E7}": self = ._457Icon
        case  "\u{F1E8}": self = ._458Icon
        case  "\u{F1E9}": self = ._459Icon
        case  "\u{F1EA}": self = ._460Icon
        case  "\u{F1EB}": self = ._461Icon
        case  "\u{F1EC}": self = ._462Icon
        case  "\u{F1ED}": self = ._463Icon
        case  "\u{F1EE}": self = ._464Icon
        case  "\u{F1F1}": self = ._466Icon
        case  "\u{F1F2}": self = ._467Icon
        case  "\u{F1F4}": self = ._469Icon
        case  "\u{F1F5}": self = ._470Icon
        case  "\u{F1F6}": self = ._471Icon
        case  "\u{F1F7}": self = ._472Icon
        case  "\u{F1F8}": self = ._473Icon
        case  "\u{F1F9}": self = ._474Icon
        case  "\u{F1FA}": self = ._475Icon
        case  "\u{F1FB}": self = ._476Icon
        case  "\u{F1FD}": self = ._478Icon
        case  "\u{F1FE}": self = ._479Icon
        case  "\u{F200}": self = ._480Icon
        case  "\u{F201}": self = ._481Icon
        case  "\u{F202}": self = ._482Icon
        case  "\u{F203}": self = ._483Icon
        case  "\u{F204}": self = ._484Icon
        case  "\u{F205}": self = ._485Icon
        case  "\u{F206}": self = ._486Icon
        case  "\u{F207}": self = ._487Icon
        case  "\u{F208}": self = ._488Icon
        case  "\u{F209}": self = ._489Icon
        case  "\u{F20A}": self = ._490Icon
        case  "\u{F20B}": self = ._491Icon
        case  "\u{F20C}": self = ._492Icon
        case  "\u{F20D}": self = ._493Icon
        case  "\u{F20E}": self = ._494Icon
        case  "\u{F211}": self = ._496Icon
        case  "\u{F213}": self = ._498Icon
        case  "\u{F214}": self = ._499Icon
        case  "\u{F215}": self = ._500Icon
        case  "\u{F216}": self = ._501Icon
        case  "\u{F217}": self = ._502Icon
        case  "\u{F218}": self = ._503Icon
        case  "\u{F219}": self = ._504Icon
        case  "\u{F21A}": self = ._505Icon
        case  "\u{F21B}": self = ._506Icon
        case  "\u{F21C}": self = ._507Icon
        case  "\u{F21D}": self = ._508Icon
        case  "\u{F21E}": self = ._509Icon
        case  "\u{F222}": self = ._511Icon
        case  "\u{F223}": self = ._512Icon
        case  "\u{F224}": self = ._513Icon
        case  "\u{F225}": self = ._514Icon
        case  "\u{F226}": self = ._515Icon
        case  "\u{F227}": self = ._516Icon
        case  "\u{F228}": self = ._517Icon
        case  "\u{F229}": self = ._518Icon
        case  "\u{F22A}": self = ._519Icon
        case  "\u{F22B}": self = ._520Icon
        case  "\u{F22C}": self = ._521Icon
        case  "\u{F22D}": self = ._522Icon
        case  "\u{F22E}": self = ._523Icon
        case  "\u{F22F}": self = ._524Icon
        case  "\u{F230}": self = ._525Icon
        case  "\u{F231}": self = ._526Icon
        case  "\u{F232}": self = ._527Icon
        case  "\u{F233}": self = ._528Icon
        case  "\u{F234}": self = ._529Icon
        case  "\u{F235}": self = ._530Icon
        case  "\u{F236}": self = ._531Icon
        case  "\u{F237}": self = ._532Icon
        case  "\u{F238}": self = ._533Icon
        case  "\u{F239}": self = ._534Icon
        case  "\u{F23A}": self = ._535Icon
        case  "\u{F23B}": self = ._536Icon
        case  "\u{F23C}": self = ._537Icon
        case  "\u{F23D}": self = ._538Icon
        case  "\u{F23E}": self = ._539Icon
        case  "\u{F240}": self = ._540Icon
        case  "\u{F241}": self = ._541Icon
        case  "\u{F242}": self = ._542Icon
        case  "\u{F243}": self = ._543Icon
        case  "\u{F244}": self = ._544Icon
        case  "\u{F245}": self = ._545Icon
        case  "\u{F246}": self = ._546Icon
        case  "\u{F247}": self = ._547Icon
        case  "\u{F248}": self = ._548Icon
        case  "\u{F249}": self = ._549Icon
        case  "\u{F24A}": self = ._550Icon
        case  "\u{F24B}": self = ._551Icon
        case  "\u{F24C}": self = ._552Icon
        case  "\u{F24D}": self = ._553Icon
        case  "\u{F24E}": self = ._554Icon
        case  "\u{F250}": self = ._555Icon
        case  "\u{F251}": self = ._556Icon
        case  "\u{F252}": self = ._557Icon
        case  "\u{F253}": self = ._558Icon
        case  "\u{F254}": self = ._559Icon
        case  "\u{F255}": self = ._560Icon
        case  "\u{F256}": self = ._561Icon
        case  "\u{F257}": self = ._562Icon
        case  "\u{F258}": self = ._563Icon
        case  "\u{F259}": self = ._564Icon
        case  "\u{F25A}": self = ._565Icon
        case  "\u{F25B}": self = ._566Icon
        case  "\u{F25C}": self = ._567Icon
        case  "\u{F25D}": self = ._568Icon
        case  "\u{F25E}": self = ._569Icon
        case  "\u{F262}": self = ._572Icon
        case  "\u{F264}": self = ._574Icon
        case  "\u{F265}": self = ._575Icon
        case  "\u{F266}": self = ._576Icon
        case  "\u{F267}": self = ._577Icon
        case  "\u{F268}": self = ._578Icon
        case  "\u{F269}": self = ._579Icon
        case  "\u{F26A}": self = ._580Icon
        case  "\u{F26B}": self = ._581Icon
        case  "\u{F26C}": self = ._582Icon
        case  "\u{F26D}": self = ._583Icon
        case  "\u{F26E}": self = ._584Icon
        case  "\u{F270}": self = ._585Icon
        case  "\u{F271}": self = ._586Icon
        case  "\u{F272}": self = ._587Icon
        case  "\u{F273}": self = ._588Icon
        case  "\u{F274}": self = ._589Icon
        case  "\u{F275}": self = ._590Icon
        case  "\u{F276}": self = ._591Icon
        case  "\u{F277}": self = ._592Icon
        case  "\u{F278}": self = ._593Icon
        case  "\u{F279}": self = ._594Icon
        case  "\u{F27A}": self = ._595Icon
        case  "\u{F27B}": self = ._596Icon
        case  "\u{F27C}": self = ._597Icon
        case  "\u{F27D}": self = ._598Icon
        case  "\u{F282}": self = ._602Icon
        case  "\u{F283}": self = ._603Icon
        case  "\u{F284}": self = ._604Icon
        case  "\u{F287}": self = ._607Icon
        case  "\u{F288}": self = ._608Icon
        case  "\u{F289}": self = ._609Icon
        case  "\u{F28A}": self = ._610Icon
        case  "\u{F28B}": self = ._611Icon
        case  "\u{F28C}": self = ._612Icon
        case  "\u{F28D}": self = ._613Icon
        case  "\u{F28E}": self = ._614Icon
        case  "\u{F290}": self = ._615Icon
        case  "\u{F291}": self = ._616Icon
        case  "\u{F292}": self = ._617Icon
        case  "\u{F293}": self = ._618Icon
        case  "\u{F294}": self = ._619Icon
        case  "\u{F295}": self = ._620Icon
        case  "\u{F296}": self = ._621Icon
        case  "\u{F297}": self = ._622Icon
        case  "\u{F298}": self = ._623Icon
        case  "\u{F299}": self = ._624Icon
        case  "\u{F29A}": self = ._625Icon
        case  "\u{F29B}": self = ._626Icon
        case  "\u{F29C}": self = ._627Icon
        case  "\u{F29D}": self = ._628Icon
        case  "\u{F29E}": self = ._629Icon
        case  "\u{F2E8}": self = ._698Icon
        case  "\u{F042}": self = .adjustIcon
        case  "\u{F170}": self = .adnIcon
        case  "\u{F037}": self = .alignCenterIcon
        case  "\u{F039}": self = .alignJustifyIcon
        case  "\u{F036}": self = .alignLeftIcon
        case  "\u{F038}": self = .alignRightIcon
        case  "\u{F0F9}": self = .ambulanceIcon
        case  "\u{F13D}": self = .anchorIcon
        case  "\u{F17B}": self = .androidIcon
        case  "\u{F107}": self = .angleDownIcon
        case  "\u{F104}": self = .angleLeftIcon
        case  "\u{F105}": self = .angleRightIcon
        case  "\u{F106}": self = .angleUpIcon
        case  "\u{F179}": self = .appleIcon
        case  "\u{F187}": self = .archiveIcon
        case  "\u{F190}": self = .arrowCircleAltLeftIcon
        case  "\u{F063}": self = .arrowDownIcon
        case  "\u{F060}": self = .arrowLeftIcon
        case  "\u{F061}": self = .arrowRightIcon
        case  "\u{F062}": self = .arrowUpIcon
        case  "\u{F069}": self = .asteriskIcon
        case  "\u{F04A}": self = .backwardIcon
        case  "\u{F05E}": self = .banCircleIcon
        case  "\u{F080}": self = .barChartIcon
        case  "\u{F02A}": self = .barcodeIcon
        case  "\u{F0C3}": self = .beakerIcon
        case  "\u{F0FC}": self = .beerIcon
        case  "\u{F0A2}": self = .bellIcon
        case  "\u{F0F3}": self = .bellAltIcon
        case  "\u{F172}": self = .bitbucketSignIcon
        case  "\u{F032}": self = .boldIcon
        case  "\u{F0E7}": self = .boltIcon
        case  "\u{F02D}": self = .bookIcon
        case  "\u{F02E}": self = .bookmarkIcon
        case  "\u{F097}": self = .bookmarkEmptyIcon
        case  "\u{F0B1}": self = .briefcaseIcon
        case  "\u{F15A}": self = .btcIcon
        case  "\u{F188}": self = .bugIcon
        case  "\u{F0F7}": self = .buildingIcon
        case  "\u{F0A1}": self = .bullhornIcon
        case  "\u{F140}": self = .bullseyeIcon
        case  "\u{F073}": self = .calendarIcon
        case  "\u{F133}": self = .calendarEmptyIcon
        case  "\u{F030}": self = .cameraIcon
        case  "\u{F083}": self = .cameraRetroIcon
        case  "\u{F0D7}": self = .caretDownIcon
        case  "\u{F0D9}": self = .caretLeftIcon
        case  "\u{F0DA}": self = .caretRightIcon
        case  "\u{F0D8}": self = .caretUpIcon
        case  "\u{F0A3}": self = .certificateIcon
        case  "\u{F046}": self = .checkIcon
        case  "\u{F096}": self = .checkEmptyIcon
        case  "\u{F147}": self = .checkMinusIcon
        case  "\u{F14A}": self = .checkSignIcon
        case  "\u{F078}": self = .chevronDownIcon
        case  "\u{F053}": self = .chevronLeftIcon
        case  "\u{F054}": self = .chevronRightIcon
        case  "\u{F13A}": self = .chevronSignDownIcon
        case  "\u{F137}": self = .chevronSignLeftIcon
        case  "\u{F138}": self = .chevronSignRightIcon
        case  "\u{F139}": self = .chevronSignUpIcon
        case  "\u{F077}": self = .chevronUpIcon
        case  "\u{F111}": self = .circleIcon
        case  "\u{F0AB}": self = .circleArrowDownIcon
        case  "\u{F0A8}": self = .circleArrowLeftIcon
        case  "\u{F0A9}": self = .circleArrowRightIcon
        case  "\u{F0AA}": self = .circleArrowUpIcon
        case  "\u{F10C}": self = .circleBlankIcon
        case  "\u{F0C2}": self = .cloudIcon
        case  "\u{F0ED}": self = .cloudDownloadIcon
        case  "\u{F0EE}": self = .cloudUploadIcon
        case  "\u{F121}": self = .codeIcon
        case  "\u{F126}": self = .codeForkIcon
        case  "\u{F0F4}": self = .coffeeIcon
        case  "\u{F013}": self = .cogIcon
        case  "\u{F085}": self = .cogsIcon
        case  "\u{F150}": self = .collapseIcon
        case  "\u{F117}": self = .collapseAltIcon
        case  "\u{F151}": self = .collapseTopIcon
        case  "\u{F0DB}": self = .columnsIcon
        case  "\u{F075}": self = .commentIcon
        case  "\u{F0E5}": self = .commentAltIcon
        case  "\u{F086}": self = .commentsIcon
        case  "\u{F0E6}": self = .commentsAltIcon
        case  "\u{F14E}": self = .compassIcon
        case  "\u{F0C5}": self = .copyIcon
        case  "\u{F09D}": self = .creditCardIcon
        case  "\u{F125}": self = .cropIcon
        case  "\u{F13C}": self = .css3Icon
        case  "\u{F0C4}": self = .cutIcon
        case  "\u{F0E4}": self = .dashboardIcon
        case  "\u{F108}": self = .desktopIcon
        case  "\u{F192}": self = .dotCircleAltIcon
        case  "\u{F103}": self = .doubleAngleDownIcon
        case  "\u{F100}": self = .doubleAngleLeftIcon
        case  "\u{F101}": self = .doubleAngleRightIcon
        case  "\u{F102}": self = .doubleAngleUpIcon
        case  "\u{F01A}": self = .downloadIcon
        case  "\u{F019}": self = .downloadAltIcon
        case  "\u{F17D}": self = .dribbleIcon
        case  "\u{F16B}": self = .dropboxIcon
        case  "\u{F044}": self = .editIcon
        case  "\u{F14B}": self = .editSignIcon
        case  "\u{F052}": self = .ejectIcon
        case  "\u{F141}": self = .ellipsisHorizontalIcon
        case  "\u{F142}": self = .ellipsisVerticalIcon
        case  "\u{F003}": self = .envelopeIcon
        case  "\u{F0E0}": self = .envelopeAltIcon
        case  "\u{F153}": self = .eurIcon
        case  "\u{F0EC}": self = .exchangeIcon
        case  "\u{F12A}": self = .exclamationIcon
        case  "\u{F06A}": self = .exclamationSignIcon
        case  "\u{F116}": self = .expandAltIcon
        case  "\u{F08E}": self = .externalLinkIcon
        case  "\u{F070}": self = .eyeCloseIcon
        case  "\u{F06E}": self = .eyeOpenIcon
        case  "\u{F0FE}": self = .f0feIcon
        case  "\u{F171}": self = .f171Icon
        case  "\u{F1A1}": self = .f1a1Icon
        case  "\u{F1A4}": self = .f1a4Icon
        case  "\u{F1AB}": self = .f1abIcon
        case  "\u{F1F3}": self = .f1f3Icon
        case  "\u{F1FC}": self = .f1fcIcon
        case  "\u{F210}": self = .f210Icon
        case  "\u{F212}": self = .f212Icon
        case  "\u{F260}": self = .f260Icon
        case  "\u{F261}": self = .f261Icon
        case  "\u{F263}": self = .f263Icon
        case  "\u{F27E}": self = .f27eIcon
        case  "\u{F09A}": self = .facebookIcon
        case  "\u{F082}": self = .facebookSignIcon
        case  "\u{F03D}": self = .facetimeVideoIcon
        case  "\u{F049}": self = .fastBackwardIcon
        case  "\u{F050}": self = .fastForwardIcon
        case  "\u{F182}": self = .femaleIcon
        case  "\u{F0FB}": self = .fighterJetIcon
        case  "\u{F15B}": self = .fileIcon
        case  "\u{F016}": self = .fileAltIcon
        case  "\u{F15C}": self = .fileTextIcon
        case  "\u{F0F6}": self = .fileTextAltIcon
        case  "\u{F008}": self = .filmIcon
        case  "\u{F0B0}": self = .filterIcon
        case  "\u{F06D}": self = .fireIcon
        case  "\u{F134}": self = .fireExtinguisherIcon
        case  "\u{F024}": self = .flagIcon
        case  "\u{F11D}": self = .flagAltIcon
        case  "\u{F11E}": self = .flagCheckeredIcon
        case  "\u{F16E}": self = .flickrIcon
        case  "\u{F07B}": self = .folderCloseIcon
        case  "\u{F114}": self = .folderCloseAltIcon
        case  "\u{F07C}": self = .folderOpenIcon
        case  "\u{F115}": self = .folderOpenAltIcon
        case  "\u{F031}": self = .fontIcon
        case  "\u{F0F5}": self = .foodIcon
        case  "\u{F04E}": self = .forwardIcon
        case  "\u{F180}": self = .foursquareIcon
        case  "\u{F119}": self = .frownIcon
        case  "\u{F0B2}": self = .fullscreenIcon
        case  "\u{F11B}": self = .gamepadIcon
        case  "\u{F154}": self = .gbpIcon
        case  "\u{F06B}": self = .giftIcon
        case  "\u{F09B}": self = .githubIcon
        case  "\u{F113}": self = .githubAltIcon
        case  "\u{F092}": self = .githubSignIcon
        case  "\u{F184}": self = .gittipIcon
        case  "\u{F000}": self = .glassIcon
        case  "\u{F0AC}": self = .globeIcon
        case  "\u{F0D5}": self = .googlePlusIcon
        case  "\u{F0D4}": self = .googlePlusSignIcon
        case  "\u{F0C0}": self = .groupIcon
        case  "\u{F0FD}": self = .hSignIcon
        case  "\u{F0A7}": self = .handDownIcon
        case  "\u{F0A5}": self = .handLeftIcon
        case  "\u{F0A4}": self = .handRightIcon
        case  "\u{F0A6}": self = .handUpIcon
        case  "\u{F0A0}": self = .hddIcon
        case  "\u{F025}": self = .headphonesIcon
        case  "\u{F004}": self = .heartIcon
        case  "\u{F08A}": self = .heartEmptyIcon
        case  "\u{F015}": self = .homeIcon
        case  "\u{F0F8}": self = .hospitalIcon
        case  "\u{F13B}": self = .html5Icon
        case  "\u{F01C}": self = .inboxIcon
        case  "\u{F03B}": self = .indentLeftIcon
        case  "\u{F03C}": self = .indentRightIcon
        case  "\u{F05A}": self = .infoSignIcon
        case  "\u{F156}": self = .inrIcon
        case  "\u{F16D}": self = .instagramIcon
        case  "\u{F033}": self = .italicIcon
        case  "\u{F157}": self = .jpyIcon
        case  "\u{F084}": self = .keyIcon
        case  "\u{F11C}": self = .keyboardIcon
        case  "\u{F159}": self = .krwIcon
        case  "\u{F109}": self = .laptopIcon
        case  "\u{F06C}": self = .leafIcon
        case  "\u{F0E3}": self = .legalIcon
        case  "\u{F094}": self = .lemonIcon
        case  "\u{F500}": self = .lessequalIcon
        case  "\u{F149}": self = .levelDownIcon
        case  "\u{F148}": self = .levelUpIcon
        case  "\u{F0EB}": self = .lightBulbIcon
        case  "\u{F0C1}": self = .linkIcon
        case  "\u{F0E1}": self = .linkedinIcon
        case  "\u{F08C}": self = .linkedinSignIcon
        case  "\u{F17C}": self = .linuxIcon
        case  "\u{F03A}": self = .listIcon
        case  "\u{F022}": self = .listAltIcon
        case  "\u{F124}": self = .locationArrowIcon
        case  "\u{F023}": self = .lockIcon
        case  "\u{F175}": self = .longArrowDownIcon
        case  "\u{F177}": self = .longArrowLeftIcon
        case  "\u{F178}": self = .longArrowRightIcon
        case  "\u{F176}": self = .longArrowUpIcon
        case  "\u{F0D0}": self = .magicIcon
        case  "\u{F076}": self = .magnetIcon
        case  "\u{F183}": self = .maleIcon
        case  "\u{F041}": self = .mapMarkerIcon
        case  "\u{F136}": self = .maxcdnIcon
        case  "\u{F0FA}": self = .medkitIcon
        case  "\u{F11A}": self = .mehIcon
        case  "\u{F130}": self = .microphoneIcon
        case  "\u{F131}": self = .microphoneOffIcon
        case  "\u{F068}": self = .minusIcon
        case  "\u{F056}": self = .minusSignIcon
        case  "\u{F146}": self = .minusSignAltIcon
        case  "\u{F10B}": self = .mobilePhoneIcon
        case  "\u{F0D6}": self = .moneyIcon
        case  "\u{F047}": self = .moveIcon
        case  "\u{F001}": self = .musicIcon
        case  "\u{F011}": self = .offIcon
        case  "\u{F00C}": self = .okIcon
        case  "\u{F05D}": self = .okCircleIcon
        case  "\u{F058}": self = .okSignIcon
        case  "\u{F0CB}": self = .olIcon
        case  "\u{F0C6}": self = .paperClipIcon
        case  "\u{F0EA}": self = .pasteIcon
        case  "\u{F04C}": self = .pauseIcon
        case  "\u{F040}": self = .pencilIcon
        case  "\u{F095}": self = .phoneIcon
        case  "\u{F098}": self = .phoneSignIcon
        case  "\u{F03E}": self = .pictureIcon
        case  "\u{F0D2}": self = .pinterestIcon
        case  "\u{F0D3}": self = .pinterestSignIcon
        case  "\u{F072}": self = .planeIcon
        case  "\u{F04B}": self = .playIcon
        case  "\u{F01D}": self = .playCircleIcon
        case  "\u{F144}": self = .playSignIcon
        case  "\u{F067}": self = .plusIcon
        case  "\u{F055}": self = .plusSignIcon
        case  "\u{F196}": self = .plusSquareOIcon
        case  "\u{F02F}": self = .printIcon
        case  "\u{F08D}": self = .pushpinIcon
        case  "\u{F12E}": self = .puzzlePieceIcon
        case  "\u{F029}": self = .qrcodeIcon
        case  "\u{F128}": self = .questionIcon
        case  "\u{F059}": self = .questionSignIcon
        case  "\u{F10D}": self = .quoteLeftIcon
        case  "\u{F10E}": self = .quoteRightIcon
        case  "\u{F074}": self = .randomIcon
        case  "\u{F021}": self = .refreshIcon
        case  "\u{F00D}": self = .removeIcon
        case  "\u{F05C}": self = .removeCircleIcon
        case  "\u{F057}": self = .removeSignIcon
        case  "\u{F18B}": self = .renrenIcon
        case  "\u{F0C9}": self = .reorderIcon
        case  "\u{F01E}": self = .repeatIcon
        case  "\u{F112}": self = .replyIcon
        case  "\u{F122}": self = .replyAllIcon
        case  "\u{F065}": self = .resizeFullIcon
        case  "\u{F07E}": self = .resizeHorizontalIcon
        case  "\u{F066}": self = .resizeSmallIcon
        case  "\u{F07D}": self = .resizeVerticalIcon
        case  "\u{F079}": self = .retweetIcon
        case  "\u{F018}": self = .roadIcon
        case  "\u{F135}": self = .rocketIcon
        case  "\u{F09E}": self = .rssIcon
        case  "\u{F158}": self = .rubIcon
        case  "\u{F0C7}": self = .saveIcon
        case  "\u{F05B}": self = .screenshotIcon
        case  "\u{F002}": self = .searchIcon
        case  "\u{F045}": self = .shareIcon
        case  "\u{F064}": self = .shareAltIcon
        case  "\u{F14D}": self = .shareSignIcon
        case  "\u{F132}": self = .shieldIcon
        case  "\u{F07A}": self = .shoppingCartIcon
        case  "\u{F0C8}": self = .signBlankIcon
        case  "\u{F012}": self = .signalIcon
        case  "\u{F090}": self = .signinIcon
        case  "\u{F08B}": self = .signoutIcon
        case  "\u{F0E8}": self = .sitemapIcon
        case  "\u{F17E}": self = .skypeIcon
        case  "\u{F118}": self = .smileIcon
        case  "\u{F0DC}": self = .sortIcon
        case  "\u{F15D}": self = .sortByAlphabetIcon
        case  "\u{F160}": self = .sortByAttributesIcon
        case  "\u{F161}": self = .sortByAttributesAltIcon
        case  "\u{F162}": self = .sortByOrderIcon
        case  "\u{F163}": self = .sortByOrderAltIcon
        case  "\u{F0DD}": self = .sortDownIcon
        case  "\u{F0DE}": self = .sortUpIcon
        case  "\u{F110}": self = .spinnerIcon
        case  "\u{F18D}": self = .stackExchangeIcon
        case  "\u{F16C}": self = .stackexchangeIcon
        case  "\u{F005}": self = .starIcon
        case  "\u{F006}": self = .starEmptyIcon
        case  "\u{F089}": self = .starHalfIcon
        case  "\u{F123}": self = .starHalfEmptyIcon
        case  "\u{F048}": self = .stepBackwardIcon
        case  "\u{F051}": self = .stepForwardIcon
        case  "\u{F0F1}": self = .stethoscopeIcon
        case  "\u{F04D}": self = .stopIcon
        case  "\u{F0CC}": self = .strikethroughIcon
        case  "\u{F12C}": self = .subscriptIcon
        case  "\u{F0F2}": self = .suitcaseIcon
        case  "\u{F185}": self = .sunIcon
        case  "\u{F12B}": self = .superscriptIcon
        case  "\u{F0CE}": self = .tableIcon
        case  "\u{F10A}": self = .tabletIcon
        case  "\u{F02B}": self = .tagIcon
        case  "\u{F02C}": self = .tagsIcon
        case  "\u{F0AE}": self = .tasksIcon
        case  "\u{F120}": self = .terminalIcon
        case  "\u{F034}": self = .textHeightIcon
        case  "\u{F035}": self = .textWidthIcon
        case  "\u{F00A}": self = .thIcon
        case  "\u{F009}": self = .thLargeIcon
        case  "\u{F00B}": self = .thListIcon
        case  "\u{F088}": self = .thumbsDownAltIcon
        case  "\u{F087}": self = .thumbsUpAltIcon
        case  "\u{F145}": self = .ticketIcon
        case  "\u{F017}": self = .timeIcon
        case  "\u{F043}": self = .tintIcon
        case  "\u{F014}": self = .trashIcon
        case  "\u{F181}": self = .trelloIcon
        case  "\u{F091}": self = .trophyIcon
        case  "\u{F0D1}": self = .truckIcon
        case  "\u{F173}": self = .tumblrIcon
        case  "\u{F174}": self = .tumblrSignIcon
        case  "\u{F099}": self = .twitterIcon
        case  "\u{F081}": self = .twitterSignIcon
        case  "\u{F0CA}": self = .ulIcon
        case  "\u{F0E9}": self = .umbrellaIcon
        case  "\u{F0CD}": self = .underlineIcon
        case  "\u{F0E2}": self = .undoIcon
        case  "\u{F1A0}": self = .uniF1A0Icon
        case  "\u{F1B0}": self = .uniF1B1Icon
        case  "\u{F1C0}": self = .uniF1C0Icon
        case  "\u{F1C1}": self = .uniF1C1Icon
        case  "\u{F1D0}": self = .uniF1D0Icon
        case  "\u{F1D1}": self = .uniF1D1Icon
        case  "\u{F1D2}": self = .uniF1D2Icon
        case  "\u{F1D5}": self = .uniF1D5Icon
        case  "\u{F1D6}": self = .uniF1D6Icon
        case  "\u{F1D7}": self = .uniF1D7Icon
        case  "\u{F1E0}": self = .uniF1E0Icon
        case  "\u{F1F0}": self = .uniF1F0Icon
        case  "\u{F280}": self = .uniF280Icon
        case  "\u{F281}": self = .uniF281Icon
        case  "\u{F285}": self = .uniF285Icon
        case  "\u{F286}": self = .uniF286Icon
        case  "\u{F2A0}": self = .uniF2A0Icon
        case  "\u{F2A1}": self = .uniF2A1Icon
        case  "\u{F2A2}": self = .uniF2A2Icon
        case  "\u{F2A3}": self = .uniF2A3Icon
        case  "\u{F2A4}": self = .uniF2A4Icon
        case  "\u{F2A5}": self = .uniF2A5Icon
        case  "\u{F2A6}": self = .uniF2A6Icon
        case  "\u{F2A7}": self = .uniF2A7Icon
        case  "\u{F2A8}": self = .uniF2A8Icon
        case  "\u{F2A9}": self = .uniF2A9Icon
        case  "\u{F2AA}": self = .uniF2AAIcon
        case  "\u{F2AB}": self = .uniF2ABIcon
        case  "\u{F2AC}": self = .uniF2ACIcon
        case  "\u{F2AD}": self = .uniF2ADIcon
        case  "\u{F2AE}": self = .uniF2AEIcon
        case  "\u{F2B0}": self = .uniF2B0Icon
        case  "\u{F2B1}": self = .uniF2B1Icon
        case  "\u{F2B2}": self = .uniF2B2Icon
        case  "\u{F2B3}": self = .uniF2B3Icon
        case  "\u{F2B4}": self = .uniF2B4Icon
        case  "\u{F2B5}": self = .uniF2B5Icon
        case  "\u{F2B6}": self = .uniF2B6Icon
        case  "\u{F2B7}": self = .uniF2B7Icon
        case  "\u{F2B8}": self = .uniF2B8Icon
        case  "\u{F2B9}": self = .uniF2B9Icon
        case  "\u{F2BA}": self = .uniF2BAIcon
        case  "\u{F2BB}": self = .uniF2BBIcon
        case  "\u{F2BC}": self = .uniF2BCIcon
        case  "\u{F2BD}": self = .uniF2BDIcon
        case  "\u{F2BE}": self = .uniF2BEIcon
        case  "\u{F2C0}": self = .uniF2C0Icon
        case  "\u{F2C1}": self = .uniF2C1Icon
        case  "\u{F2C2}": self = .uniF2C2Icon
        case  "\u{F2C3}": self = .uniF2C3Icon
        case  "\u{F2C4}": self = .uniF2C4Icon
        case  "\u{F2C5}": self = .uniF2C5Icon
        case  "\u{F2C6}": self = .uniF2C6Icon
        case  "\u{F2C7}": self = .uniF2C7Icon
        case  "\u{F2C8}": self = .uniF2C8Icon
        case  "\u{F2C9}": self = .uniF2C9Icon
        case  "\u{F2CA}": self = .uniF2CAIcon
        case  "\u{F2CB}": self = .uniF2CBIcon
        case  "\u{F2CC}": self = .uniF2CCIcon
        case  "\u{F2CD}": self = .uniF2CDIcon
        case  "\u{F2CE}": self = .uniF2CEIcon
        case  "\u{F2D0}": self = .uniF2D0Icon
        case  "\u{F2D1}": self = .uniF2D1Icon
        case  "\u{F2D2}": self = .uniF2D2Icon
        case  "\u{F2D3}": self = .uniF2D3Icon
        case  "\u{F2D4}": self = .uniF2D4Icon
        case  "\u{F2D5}": self = .uniF2D5Icon
        case  "\u{F2D6}": self = .uniF2D6Icon
        case  "\u{F2D7}": self = .uniF2D7Icon
        case  "\u{F2D8}": self = .uniF2D8Icon
        case  "\u{F2D9}": self = .uniF2D9Icon
        case  "\u{F2DA}": self = .uniF2DAIcon
        case  "\u{F2DB}": self = .uniF2DBIcon
        case  "\u{F2DC}": self = .uniF2DCIcon
        case  "\u{F2DD}": self = .uniF2DDIcon
        case  "\u{F2DE}": self = .uniF2DEIcon
        case  "\u{F2E0}": self = .uniF2E0Icon
        case  "\u{F2E1}": self = .uniF2E1Icon
        case  "\u{F2E2}": self = .uniF2E2Icon
        case  "\u{F2E3}": self = .uniF2E3Icon
        case  "\u{F2E4}": self = .uniF2E4Icon
        case  "\u{F2E5}": self = .uniF2E5Icon
        case  "\u{F2E6}": self = .uniF2E6Icon
        case  "\u{F2E7}": self = .uniF2E7Icon
        case  "\u{F2E9}": self = .uniF2E9Icon
        case  "\u{F2EA}": self = .uniF2EAIcon
        case  "\u{F2EB}": self = .uniF2EBIcon
        case  "\u{F2EC}": self = .uniF2ECIcon
        case  "\u{F2ED}": self = .uniF2EDIcon
        case  "\u{F2EE}": self = .uniF2EEIcon
        case  "\u{F127}": self = .unlinkIcon
        case  "\u{F09C}": self = .unlockIcon
        case  "\u{F13E}": self = .unlockAltIcon
        case  "\u{F01B}": self = .uploadIcon
        case  "\u{F093}": self = .uploadAltIcon
        case  "\u{F155}": self = .usdIcon
        case  "\u{F007}": self = .userIcon
        case  "\u{F0F0}": self = .userMdIcon
        case  "\u{F221}": self = .venusIcon
        case  "\u{F194}": self = .vimeoSquareIcon
        case  "\u{F189}": self = .vkIcon
        case  "\u{F027}": self = .volumeDownIcon
        case  "\u{F026}": self = .volumeOffIcon
        case  "\u{F028}": self = .volumeUpIcon
        case  "\u{F071}": self = .warningSignIcon
        case  "\u{F18A}": self = .weiboIcon
        case  "\u{F17A}": self = .windowsIcon
        case  "\u{F0AD}": self = .wrenchIcon
        case  "\u{F168}": self = .xingIcon
        case  "\u{F169}": self = .xingSignIcon
        case  "\u{F167}": self = .youtubeIcon
        case  "\u{F16A}": self = .youtubePlayIcon
        case  "\u{F166}": self = .youtubeSignIcon
        case  "\u{F00E}": self = .zoomInIcon
        case  "\u{F010}": self = .zoomOutIcon
        default: self = FontAwesomeIcon(rawValue: 0)!
        }
    }
